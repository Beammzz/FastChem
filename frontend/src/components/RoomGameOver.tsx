  ...
  return (
    <div className="w-full max-w-lg mx-auto animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          onClick={onPlayAgain}
          className="flex-1 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold py-3 px-6 rounded-xl hover:opacity-90 transition-opacity cursor-pointer min-h-[44px]"
        >
          สร้างห้องใหม่
        </button>
        <button
